...
<?php $hm->Title( __FILE__, RSTR_APP_TITLE, RSTR_PEOPLE, $hm->Zb( 'page:caption_verb' ) ); ?>
...
<?php include(INC_BODY_INFO); ?>
	...
	<!-- [BEGIN] basic_info -->
	<?php echo $hm->SectBegin( $hm->Zb( 'page:caption_verb' ) ); ?>
	...
	<tr>
		<td class='column_caption'><span class="required"></span>
			<?php echo RSTR_PEOPLE_ID; ?> : </td>
		<td class='column_value'><?php echo $hm->Zb('rs:def:people_id'); ?></td>
	</tr>
	<?php } ?>
	...
	<tr>
		<td class='column_caption'>
			<?php if ( $b_reg || $b_edit ) { ?><span class="required"></span><?php } ?>
			<?php echo RSTR_PRIMARY; ?> :
		</td>
		<td class='column_value'><?php echo $hm->Zb('rs:def:primary'); ?>
		</td>
	</tr>
	<tr>
		<td class='column_caption'>
			<?php if ( $b_reg || $b_edit ) { ?><span class="required"></span><?php } ?>
			<?php echo RSTR_SECONDARY; ?> :
		</td>
		<td class='column_value'><?php echo $hm->Zb('rs:def:secondary'); ?>
		</td>
	</tr>
	<tr>
		<td class='column_caption'>
			<?php if ( $b_reg || $b_edit ) { ?><span class="required"></span><?php } ?>
			<?php echo RSTR_PRIVILEGES; ?> :
		</td>
		<td class='column_value'><?php echo $hm->Zb('rs:def:privileges'); ?>
		</td>
	</tr>
	<tr>
		<td class='column_caption'>
			<?php if ( $b_reg || $b_edit ) { ?><span class="required"></span><?php } ?>
			<?php echo RSTR_LANGUAGE; ?> :
		</td>
		<td class='column_value'><?php echo $hm->Zb('rs:def:language'); ?>
		</td>
	</tr>
	<tr>
		<td class='column_caption'>
