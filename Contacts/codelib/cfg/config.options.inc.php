...
//-- Specifies internal encoding used in the script
...
//-- Dumps the deleted records to log table
define( 'DUMP_DELETED_RECORD', false );

//-- Includes lang code in template file name
define( 'MULTI_LANG_TEMPLATE', false );

//-- Saves html page on disk
define( 'SAVE_AS_HTML_PAGE', false );

//-- The prefix for the init value array
