...
class CToHtml
{
	public static function GetNormSCList()
	{
		return array(
			'frame.login'=>'index',
			'frame.logoff'=>'index',
	...
	public static function Save( $pageset, $cmd, $txt )
	{
	...
	public static function ReplaceLinkDest( $ps, &$txt )
	{
	...
	public static function ReplaceButtonDest( $ps, &$txt )
	{
		$sepa = " name=\"_sc=";
		$tx = explode( $sepa, $txt );
	...
	public static function NormalizeSC( $sc )
	{
	...
	public static function RemovePostfix( &$s, $postfix )
	{
	...
	public static function RemoveTag( &$s, $key )
	{
