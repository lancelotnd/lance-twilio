...
class CGenLog
{
	public static function dq( &$db, $s )
	{
		return "'" . $db->Sanitize( $s ) . "'";
	}

	public static function Send( &$sys, $Sender, $Subject, $Body, $Format = 'T' )
	{
	...
	public static function DeleteExpired( &$sys )
	{
	...
	public static function DumpRecord( &$sys, $sql )
	{
		$db =& $sys->DB;
