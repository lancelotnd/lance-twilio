...
class CValidator
{
	...
	public static function IsEmailAddress( $v )
	{
		$s = trim( $v );
		if ( $s  != "" )
		{
	...
	public static function DateExists( $year, $month, $day )
	{
	...
	public static function IsYYYYMMDD_HHMMSS( $s )
	{
	...
	public static function IsDateTime( $s )
	{
